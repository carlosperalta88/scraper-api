...
describe('cases service', function() {
  ...
  it('should compare equal cases', () => {
    const result = CasesDataService.compare([mockData.caseA, mockData.caseA])
    expect(result).not.to.be.a('null')
    expect(result).to.be.empty
  })

  it('should compare cases with more history', () => {
    const caseData = mockData.caseA
    const caseDataB = mockData.caseB
    const result = CasesDataService.compare([caseData, caseDataB])
    expect(result).not.to.be.a('null')
    expect(result).not.to.be.empty
    expect(result).to.be.an('array').that.include('cause_history')
  })

  it('should compare cases with less history', () => {
    const caseData = mockData.caseA
    const caseDataB = mockData.caseC
    const result = CasesDataService.compare([caseData, caseDataB])
    expect(result).not.to.be.a('null')
    expect(result).not.to.be.empty
    expect(result).to.be.an('array').that.include('cause_history')
  ...
  it('should compare cases with more exhorts', () => {
    const caseData = mockData.caseA
    const caseDataB = mockData.caseD
    const result = CasesDataService.compare([caseData, caseDataB])
    expect(result).not.to.be.a('null')
    expect(result).not.to.be.empty
    expect(result).to.be.an('array').that.include('exhorts')
  })

  it('should compare cases with less exhorts', () => {
    const caseData = mockData.caseA
    const caseDataB = mockData.caseE
    const result = CasesDataService.compare([caseData, caseDataB])
    expect(result).not.to.be.a('null')
    expect(result).not.to.be.empty
    expect(result).to.be.an('array').that.include('exhorts')
  ...
  it('should compare cases with more pending docs', () => {
    const caseData = mockData.caseA
    const caseDataB = mockData.caseF
    const result = CasesDataService.compare([caseData, caseDataB])
    expect(result).not.to.be.a('null')
    expect(result).not.to.be.empty
    expect(result).to.be.an('array').that.include('pending_docs')
  })

  it('should compare cases with different receptor data', () => {
    const caseData = mockData.caseA
    const caseDataB = mockData.caseG
    const result = CasesDataService.compare([caseData, caseDataB])
    expect(result).not.to.be.a('null')
    expect(result).not.to.be.empty
    expect(result).to.be.an('array').that.include('receptor')
  })

  it('should compare cases with more than one difference', () => {
    const caseData = mockData.caseA
    const caseDataB = mockData.caseH
    const result = CasesDataService.compare([caseData, caseDataB])
    expect(result).not.to.be.a('null')
    expect(result).not.to.be.empty
    expect(result)
  ...
  difference in different order`, () => {
    const caseData = mockData.caseI
    const caseDataB = mockData.caseJ
